...
public extension Errno {
  ...
  @_alwaysEmitIntoClient
  static var wouldBlock: Errno { Errno(EWOULDBLOCK) }
}

public extension Errno {
  @_alwaysEmitIntoClient
  static func ~= (_ lhs: Errno, _ rhs: Error) -> Bool {
...
extension Errno: CustomStringConvertible, CustomDebugStringConvertible {
  ...
  public var description: String {
    guard let ptr = strerror(rawValue) else { return "unknown error" }
